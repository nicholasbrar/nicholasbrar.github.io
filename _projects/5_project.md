...
<div class="row">
    <div class="col-sm-12 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/dealershock_mobile/IMG_6759.PNG" title="Dealer Shock app" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="row">
    <div class="col-sm-12 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/dealershock_mobile/IMG_6760.PNG" title="Dealer Shock app" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="row">
    <div class="col-sm-12 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/dealershock_mobile/IMG_6761.PNG" title="Dealer Shock app" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="row">
    <div class="col-sm-12 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/dealershock_mobile/IMG_6763.PNG" title="Dealer Shock app" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="row">
    <div class="col-sm-12 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/dealershock_mobile/IMG_6764.PNG" title="Add to Inventory with VIN scan" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
